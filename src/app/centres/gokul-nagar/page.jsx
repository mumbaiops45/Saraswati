...
const centre = {
  name:        "Gokul-Nagar",
  slug:        "Gokul-nagar",
  tagline:     "Central Thane West · Gokul-nagar",
  heroDesc:    "The Saraswati Educare Gokul-nagar coaching centre is centrally located in Gokul-nagar, Thane West, serving students from Gokul-nagar, Kolbad, Lodha Splendora, Vasant Vihar, Brahmand and Eastern Express Highway areas. Students from nearby schools in Gokul-nagar regularly choose our Gokul-nagar coaching centre for 11th and 12th science, IIT JEE and NEET preparation.",
  address:     "Address to be provided by client — Gokul-nagar, Thane West",
  landmark:    "Near Gokul-nagar Junction, Thane West",
  phone:       "+91 XXXXX XXXXX",
  whatsapp:    "https://wa.me/91XXXXXXXXXX",
  email:       "Gokul-nagar@saraswatieducare.com",
  ...
  faqs: [
    { q: "Where is the Gokul-nagar coaching centre located?",                        a: "Our Gokul-nagar coaching centre is located near Gokul-nagar Junction in Thane West, easily accessible from Lodha Splendora, Brahmand and the Eastern Express Highway. Exact address will be updated shortly — please call or WhatsApp us." },
    { q: "Which courses are available at Gokul-nagar?",                              a: "All six Saraswati Educare programmes are available at our Gokul-nagar coaching centre: Foundation (Class 7–10), 11th-12th Science, IIT JEE, NEET UG, MHT-CET and Olympiad coaching." },
    { q: "How do I book a free demo class at the Gokul-nagar coaching centre?",      a: "Call us, WhatsApp us or fill the form on this page. We will schedule your free demo class at our Gokul-nagar centre within 24 hours — no fees, no commitment." },
    { q: "Is Gokul-nagar coaching centre suitable for NEET aspirants?",              a: "Yes. The Gokul-nagar centre has dedicated NEET batches with NEET-qualified faculty covering Physics, Chemistry, Botany and Zoology with special NCERT-mastery sessions." },
    { q: "Do coaching classes in Gokul-nagar run on weekends?",                      a: "Yes. Weekend batches are available at select timings at the Gokul-nagar coaching centre to accommodate students with school schedules or working parents." },
  ],
  hours: [
