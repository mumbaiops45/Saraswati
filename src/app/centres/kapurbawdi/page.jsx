...
const centre = {
  name:        "Kapurbawdi",
  slug:        "kapurbawdi",
  tagline:     "Flagship Centre · Thane West",
  ...
  nearbyAreas: ["Majiwada", "Pokhran Road", "Vartak Nagar", "Brahmand", "Ghodbunder Road", "Hiranandani Estate"],
  courses: [
  ...
  stats: [
    { val: "22+", label: "Years at This Centre" },
    { val: "50+", label: "Batches per Year"      },
    { val: "30",  label: "Max Batch Size"        },
    { val: "6",   label: "Courses Offered"       },
  ],
  toppers: [
    { name: "Deva Vishwakarma", exam: "IIT JEE Mains", score: "AIR 2,92,659", year: "2021", initials: "DV", color: "from-amber-400 to-orange-500" },
    { name: "Aisha Khan",       exam: "HSC Board",     score: "96.40%",        year: "2022", initials: "AK", color: "from-blue-400 to-indigo-500"  },
    { name: "Kavya Thakur",     exam: "MHT-CET",       score: "96.80 %ile",    year: "2023", initials: "KT", color: "from-violet-400 to-purple-500"},
  ],
  faqs: [
    { q: "Where exactly is the Kapurbawdi coaching centre located?",           a: "The Kapurbawdi coaching centre is located near Kapurbawdi Junction on Ghodbunder Road, Thane West. The exact address will be updated shortly — please call or WhatsApp us for directions." },
    { q: "Which courses are available at Kapurbawdi?",                         a: "All six Saraswati Educare programmes are available at Kapurbawdi: Foundation (Class 7–10), 11th-12th Science, IIT JEE, NEET UG, MHT-CET and Olympiad coaching." },
    { q: "How do I book a free demo class at the Kapurbawdi centre?",          a: "Simply call us, WhatsApp us or fill the enquiry form on this page. We will schedule your free demo class at Kapurbawdi within 24 hours." },
    { q: "Are the coaching classes in Kapurbawdi suitable for CBSE students?", a: "Yes. Our Kapurbawdi coaching centre serves students from CBSE, ICSE and Maharashtra State Board. Faculty is trained to handle all three boards simultaneously within the same batch." },
    { q: "What are the batch timings at the Kapurbawdi coaching centre?",      a: "Batch timings vary by programme and are updated each academic year. Please contact the Kapurbawdi centre directly for the current batch schedule." },
  ],
  hours: [
...
export default function Page() {
  ...
  return (
    <div className=" bg-white text-gray-900 overflow-x-hidden">
      ...
      <section
        className="clip-hero min-h-[68vh] flex items-center relative overflow-hidden pt-24 pb-32"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <AnimatedSection>
              ...
              <h2 className="font-display text-3xl lg:text-4xl text-gray-900 mt-5 mb-6">
                Your Nearest Coaching Centre<br />at <span className="gold-text">{centre.name} Junction</span>
              </h2>
              <p className="text-gray-600 leading-relaxed mb-8">
                The coaching classes in {centre.name} at Saraswati Educare are designed for students who want
                expert guidance close to home. Students from {centre.nearbyAreas.slice(0, 4).join(", ")} and
          ...
          <AnimatedSection>
            <div className="text-center mb-12">
              ...
              <p className="text-gray-500 mt-3 max-w-xl mx-auto text-sm">
                All six Saraswati Educare programmes are available at our {centre.name} coaching centre.
              </p>
            </div>
          </AnimatedSection>
          ...
          <AnimatedSection delay={0.1}>
            <div className="flex flex-wrap gap-3 justify-center">
              {centre.nearbyAreas.map((area, i) => (
                <span key={i}
                  className={`${centre.bgLight} ${centre.borderLight} border ${centre.textAccent} font-semibold text-sm px-4 py-2 rounded-full`}>
                  📍 {area}
                </span>
              ))}
            </div>
            ...
            {centre.toppers.map((t, i) => (
              <AnimatedSection key={i} delay={i * 0.1}>
                <div className="card-hover text-center bg-white rounded-2xl border border-gray-100 shadow-md p-7 relative overflow-hidden">
                  ...
                  <div className={`w-16 h-16 bg-gradient-to-br ${t.color} rounded-full flex items-center justify-center text-white text-xl font-bold mx-auto mb-5 shadow-lg`}>
                    {t.initials}
                  </div>
                ...
                <form onSubmit={handleSubmit} noValidate>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input value={centre.name} readOnly className="w-full bg-amber-50 border border-amber-200 rounded-xl px-4 py-3 text-sm text-amber-800 font-semibold" />
                    </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-6">
          <AnimatedSection>
            <div className="text-center mb-12">
              <span className="text-amber-600 text-xs font-bold tracking-widest uppercase bg-amber-50 border border-amber-200 px-4 py-1.5 rounded-full">FAQ</span>
            ...
            {centre.faqs.map((faq, i) => (
              <AnimatedSection key={i} delay={i * 0.07}>
                <div className={`rounded-2xl border overflow-hidden transition-all duration-300 ${
                  openFaq === i ? "border-amber-200 bg-amber-50/50" : "border-gray-100 bg-white hover:border-gray-200"
                }`}>
                  ...
                  <div className="faq-body" style={{ maxHeight: openFaq === i ? "200px" : "0", opacity: openFaq === i ? 1 : 0 }}>
                    <div className="px-6 pb-5 text-gray-600 text-sm leading-relaxed border-t border-amber-100 pt-4">{faq.a}</div>
                  </div>
                </div>
              </AnimatedSection>
            ))}
            ...
            {allCentres.map((c, i) => (
              <AnimatedSection key={i} delay={i * 0.06}>
                <a href={`/centres/${c.slug}`}
                  ...
                  <div className="w-10 h-10 gold-gradient rounded-xl flex items-center justify-center text-white font-bold text-sm mx-auto mb-2 shadow-sm">
                    {c.slug === centre.slug ? "✓" : "S"}
                  </div>
                  <div className={`font-semibold text-xs ${c.slug === centre.slug ? centre.textAccent : "text-gray-700"}`}>
                    {c.name}
                  </div>
                  {c.slug === centre.slug && (
                    <div className="text-amber-500 text-xs mt-0.5">You are here</div>
                  )}
                </a>
              </AnimatedSection>
            ))}
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
          <AnimatedSection>
            ...
            <p className="text-white/85 text-lg mb-10 leading-relaxed">
              Limited seats available at our {centre.name} coaching centre. Book a free demo — no commitment, no pressure.
            </p>
