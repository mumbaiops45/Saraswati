...
const centre = {
  name:        "Kasheli",
  slug:        "Kasheli",
  tagline:     "Central Thane West · Kasheli",
  heroDesc:    "The Saraswati Educare Kasheli coaching centre is centrally located in Kasheli, Thane West, serving students from Kasheli, Kolbad, Lodha Splendora, Vasant Vihar, Brahmand and Eastern Express Highway areas. Students from nearby schools in Kasheli regularly choose our Kasheli coaching centre for 11th and 12th science, IIT JEE and NEET preparation.",
  address:     "Address to be provided by client — Kasheli, Thane West",
  landmark:    "Near Kasheli Junction, Thane West",
  phone:       "+91 XXXXX XXXXX",
  whatsapp:    "https://wa.me/91XXXXXXXXXX",
  email:       "Kasheli@saraswatieducare.com",
  ...
  faqs: [
    { q: "Where is the Kasheli coaching centre located?",                        a: "Our Kasheli coaching centre is located near Kasheli Junction in Thane West, easily accessible from Lodha Splendora, Brahmand and the Eastern Express Highway. Exact address will be updated shortly — please call or WhatsApp us." },
    { q: "Which courses are available at Kasheli?",                              a: "All six Saraswati Educare programmes are available at our Kasheli coaching centre: Foundation (Class 7–10), 11th-12th Science, IIT JEE, NEET UG, MHT-CET and Olympiad coaching." },
    { q: "How do I book a free demo class at the Kasheli coaching centre?",      a: "Call us, WhatsApp us or fill the form on this page. We will schedule your free demo class at our Kasheli centre within 24 hours — no fees, no commitment." },
    { q: "Is Kasheli coaching centre suitable for NEET aspirants?",              a: "Yes. The Kasheli centre has dedicated NEET batches with NEET-qualified faculty covering Physics, Chemistry, Botany and Zoology with special NCERT-mastery sessions." },
    { q: "Do coaching classes in Kasheli run on weekends?",                      a: "Yes. Weekend batches are available at select timings at the Kasheli coaching centre to accommodate students with school schedules or working parents." },
  ],
  hours: [
